...
const complaints = [
  { id: 1, title: "Time waste", date: "15/12/2025", message: "Happy", status: "Pending" },
  { id: 2, title: "water is too cold", date: "11/12/2025", message: "we want heater because of winter water is too cold", status: "Pending" },
  { id: 3, title: "hello dear", date: "10/12/2025", message: "just wanted to know about your health hope you are fine", status: "Resolved" },
  { id: 4, title: "broom", date: "10/12/2025", message: "do not broom", status: "Rejected" },
  { id: 1, title: "Time waste", date: "15/12/2025", message: "Happy", status: "Pending" },
  { id: 2, title: "water is too cold", date: "11/12/2025", message: "we want heater because of winter water is too cold", status: "Pending" },
  { id: 3, title: "hello dear", date: "10/12/2025", message: "just wanted to know about your health hope you are fine", status: "Resolved" },
  { id: 4, title: "broom", date: "10/12/2025", message: "do not broom", status: "Rejected" },
      ...
      <div className="flex-none mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Report issues and track their status in real-time.</p>
          </div>
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px] bg-[#020617] border-slate-800 text-slate-100">
              <DialogHeader>
                <DialogTitle className="text-xl font-bold">Submit a Complaint</DialogTitle>
              ...
              <div className="space-y-6 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    ...
                    className="min-h-[120px] bg-slate-950 border-slate-800 focus:ring-slate-700"
                  />
                </div>
              </div>
              <Button type="submit" className="w-full bg-white text-black hover:bg-slate-200 font-bold h-11">
                Submit Complaint
              </Button>
            </DialogContent>
          </Dialog>
...
function StatusBadge({ status }: { status: string }) {
  const configs: Record<string, { color: string; icon: React.ReactNode }> = {
    Pending: { color: "bg-amber-500/10 text-amber-500 border-amber-500/20", icon: <Clock size={12} /> },
    Resolved: { color: "bg-emerald-500/10 text-emerald-500 border-emerald-500/20", icon: <CheckCircle2 size={12} /> },
    Rejected: { color: "bg-rose-500/10 text-rose-500 border-rose-500/20", icon: <XCircle size={12} /> },
  };
  const config = configs[status];
  return (
    <Badge variant="outline" className={`${config.color} px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 border-none shadow-none`}>
      {config.icon} {status}
    </Badge>
  );
}
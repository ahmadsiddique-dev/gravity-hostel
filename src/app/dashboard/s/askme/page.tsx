...
const page = () => {
  ...
  return (
    <>
    <Card className="md:w-[60vw]  mx-2.5 my-3.5 sm:mx-auto">
    <ScrollArea className="h-[60vh] flex flex-col justify-center items-center w-full">
      ...
      <div className="grid px-2.5  w-full sm:mx-auto mb-2.5 max-w-sm gap-6">
        <InputGroup>

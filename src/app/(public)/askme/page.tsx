...
export default function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full max-w-3xl mx-auto relative overflow-hidden bg-background">
        ...
        >
          <div className="flex items-end gap-2 px-1 sm:px-2">
            <Textarea
              ...
              disabled={isTyping}
              className="flex-1 min-h-[44px] max-h-36 bg-transparent border-0 focus-visible:ring-0 resize-none py-3 text-sm placeholder:text-muted-foreground/60"
              rows={1}
            />
            <Button
              type="submit"
